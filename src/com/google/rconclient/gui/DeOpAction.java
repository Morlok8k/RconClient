...
/**
 * The action to be used to take a player operator rights.
 * 
 * @author vincent
 */
public class DeOpAction extends AbstractAction {
	 ...
	 */
	private static final ResourceBundle MESSAGES = new Messages(DeOpAction.class);

	private static final String MSG_CLASS_NAME = DeOpAction.class.getSimpleName();
	 ...
	 *            The list with the selected items.
	 */
	public DeOpAction(final Globals globals, final JList<String> list) {
		super();
