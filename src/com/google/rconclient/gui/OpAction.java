...
/**
 * The action to be used to give a player operator rights.
 * 
 * @author vincent
 */
public class OpAction extends AbstractAction {
	 ...
	 */
	private static final ResourceBundle MESSAGES = new Messages(OpAction.class);

	private static final String MSG_CLASS_NAME = OpAction.class.getSimpleName();
	 ...
	 *            The list with the selected items.
	 */
	public OpAction(final Globals globals, final JList<String> list) {
		super();
