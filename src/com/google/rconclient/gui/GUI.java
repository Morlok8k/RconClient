...
public class GUI implements Runnable {
	...
	private static final String MSG_FILE_MENU_TEXT = MSG_CLASS_NAME
			+ ".fileMenu.text";
	private static final String MSG_FILE_MENU_MNEMONIC = MSG_CLASS_NAME
			+ ".fileMenu.mnemonic";
	private static final String MSG_SERVER_MENU_TEXT = MSG_CLASS_NAME
			+ ".serverMenu.text";
	private static final String MSG_SERVER_MENU_MNEMONIC = MSG_CLASS_NAME
			+ ".serverMenu.mnemonic";
	private static final String MSG_BAN_IP_LIST_TITLE = MSG_CLASS_NAME
			+ ".banIpList.title";
	private static final String MSG_BAN_LIST_TITLE = MSG_CLASS_NAME
			+ ".banList.title";
	private static final String MSG_USER_LIST_TITLE = MSG_CLASS_NAME
			+ ".userList.title";
	private static final String MSG_WHITE_LIST_TITLE = MSG_CLASS_NAME
			+ ".whiteList.title";
	...
	public void run() {
		...
		JLabel lblConnected_To = new JLabel("Connected to:");
		panel.add(lblConnected_To);

		JLabel lblConn = new JLabel("[Disconnected]");
		panel.add(lblConn);
	...
	private JComponent createBanIpList() {
		...
		final Border border = BorderFactory.createTitledBorder(MESSAGES
				.getString(MSG_BAN_IP_LIST_TITLE));
	...
	private JMenuBar createMenuBar() {
		...
		fileMenu.setMnemonic(KeyEventUtil.getKeyCode(MESSAGES
				.getString(MSG_FILE_MENU_MNEMONIC)));
		...
		serverMenu.setMnemonic(KeyEventUtil.getKeyCode(MESSAGES
				.getString(MSG_SERVER_MENU_MNEMONIC)));
	...
	private JComponent createWhiteList() {
		...
		final Border border = BorderFactory.createTitledBorder(MESSAGES
				.getString(MSG_WHITE_LIST_TITLE));
		scrollPane.setBorder(border);
