...
public class PardonIpAction extends AbstractAction {
	 ...
	 */
	private static final ResourceBundle MESSAGES = new Messages(PardonIpAction.class);

	private static final String MSG_CLASS_NAME = PardonIpAction.class.getSimpleName();
